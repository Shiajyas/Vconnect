...
const stripePromise = loadStripe("pk_test_51R96FJH8pkRmmJ6859FuaBwszQN9xD2Z46Tflj0UAyQ399Jbtas29w20el9NbCvhy2nWqY5y9p0kd9ANqMMe9fKy00X5qntRpU");
...
const StripePayment: React.FC<StripePaymentProps> = ({ userId, onSuccess, refreshSubscription }) => {
