...
export interface ICommentRepository {
    ...
    addReply(parentCommentId: mongoose.Types.ObjectId, replyId: string): Promise<void>;
  
    deleteComment(commentId: string): Promise<boolean>;
  
    likeComment(commentId: string, userId: string): Promise<{ commentId: string; likes: mongoose.Types.ObjectId[] }>;

    unLikeComment(commentId: string, userId: string): Promise<{ commentId: string; likes: mongoose.Types.ObjectId[]  }>;
