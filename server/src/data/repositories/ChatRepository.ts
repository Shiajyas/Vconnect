      ...
      return {
        ...
        replyTo: savedMessage.replyTo
          ? {
              ...
              sender:
                typeof savedMessage.replyTo === "object" && "senderId" in savedMessage.replyTo
                  ? (savedMessage.replyTo.senderId as any)._id || savedMessage.replyTo.senderId
                  : "",
            }
          : null,
        ...
        ? {
            ...
            sender:
              typeof msg.replyTo === "object" && "senderId" in msg.replyTo
                ? (msg.replyTo.senderId as any)?._id?.toString() ?? msg.replyTo.senderId.toString()
                : "",
          }
        : null,
    ...
    lastMessage: chat.lastMessage
      ? {
          ...
          sender: typeof chat.lastMessage === "object" && "senderId" in chat.lastMessage
            ? (chat.lastMessage.senderId as any)?._id?.toString() ?? chat.lastMessage.senderId.toString()
            : "",
          type: typeof chat.lastMessage === "object" && "type" in chat.lastMessage ? chat.lastMessage.type : "text",
          files: typeof chat.lastMessage === "object" && "files" in chat.lastMessage ? chat.lastMessage.files : [],
        }
      : null,
    isGroupChat: chat.isGroupChat,
    createdAt: chat.createdAt,
