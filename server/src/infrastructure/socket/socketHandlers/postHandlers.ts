...
export const postHandlers = (socket: Socket, postSocketHandlers: IPostSocketService) => {
  ...
  await  postSocketHandlers.likePost(socket, data.userId, data.postId, data.type);
  });
